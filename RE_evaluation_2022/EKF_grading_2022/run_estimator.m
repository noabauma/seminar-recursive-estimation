function [trackErrorNorm,angularErrorNorm,velocityErrorNorm,windErrorNorm,biasErrorNorm,initialEst,initialVar,tEstAvg]=run_estimator(simConst,estConst,doplot,seed)
%
%

function const = SimulationConstVar2()
% 
...
const.m = 0.1;  % Uniform distribution parameter of points p1 and p2
const.l = 0.1;  % Uniform distribution parameter of points p9 and p10

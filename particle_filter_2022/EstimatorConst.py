...
class EstimatorConst:
    def __init__(self):
        ...
        """ Initialization """
        self.pA = [1.4, 0.8] # Center point pA of the initial position distribution
        self.pB = [2.0, 1.8] # Center point pB of the initial position distribution
        self.d = 0.1  # Radius of shaded regions for initialization

        self.phi_0 = np.pi/3.0 # Initial heading is uniformly distr. in [-phi_0,phi_0]

        self.m = 0.1  # Uniform distribution parameter of points p1 and p2
